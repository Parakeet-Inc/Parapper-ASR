use super::super::*;
use crate::{SourceIdentitySnapshot, SourceSessionKey};
    ...
    assert_eq!(
        *outputs.lock().expect("outputs should be readable"),
        vec![PhraseOutputSnapshot {
            ...
            turn_session_id: 1,
            source_session: SourceSessionKey::legacy_single_source(1),
            source_identity: SourceIdentitySnapshot::legacy_single_source(),
            turn_id: 1,
            segment_id: 1,
            output_sequence: 1,
